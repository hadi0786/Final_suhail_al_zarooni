...
const CardDetails = ({setActiveStep}) => {
...
<div class="payment-title">
    ...
    <div class="containerPayment preload">
    ...
    <div className='flexBoxButton reg_btn'> 
                <input type="submit" value="Back" className='buttonDetailsPage' onClick={()=>setActiveStep(1)}/>
                <input type="submit" value="Finish" className='buttonDetailsPage' onClick={()=>setActiveStep(1)}/>
                </div>
